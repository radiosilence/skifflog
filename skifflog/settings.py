# Django settings for skifflog project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'skifflog',                      # Or path to database file if using sqlite3.
        'USER': 'skifflog',                      # Not used with sqlite3.
        'PASSWORD': 'skifflog',                  # Not used with sqlite3.
...
AUTH_PROFILE_MODULE = "skifflog.UserProfile"
...
WSGI_APPLICATION = 'skifflog.wsgi.application'
